...
if __name__ == "__main__":
    ...
    model_publisher.create_algorithm_on_env("Python 3.7")
    example_template_utils.copy_example_algo_templates(
        algo_name, model_publisher.repo_path, "py37_with_manifest"
    )
    model_publisher.release_algo_with_model(local_model_path, should_upload_model=True)
